...
namespace XRMultiplayer
{
    ...
    public class AntiGravityZone : MonoBehaviour
    {
        ...
        public void PowerOff()
        {
            ...
            if (m_CharacterController != null)
            {
                m_CharacterController.GetComponentInChildren<GravityProvider>().useGravity = true;
        ...
        private void SubTriggerEntered(Collider other)
        {
            ...
            else
            {
                ...
                if (other.TryGetComponent(out CharacterController controller))
                {
                    ...
                    m_CharacterController.GetComponentInChildren<GravityProvider>().useGravity = false;
                }
            }
        }
        ...
        private void SubTriggerExited(Collider other)
        {
            ...
            else
            {
                if (other.TryGetComponent(out CharacterController controller))
                {
                    controller.GetComponentInChildren<GravityProvider>().useGravity = true;
                    m_CharacterController = null;
                }
            }
        }
